	...
	tests := []struct {
		...
		},
		{
			...
			wantConfig: &Config{
				...
				AllowUnreachableCodeSet:      true,
			},
		},
		{
			name: "negated allow-unreachable-code",
			args: []string{"--no-allow-unreachable-code", "in.ts"},
			wantConfig: &Config{
				Strict:                       true,
				NoImplicitAny:                true,
				StrictNullChecks:             true,
		...
		{
			name: "allow-unused-labels flag",
			args: []string{"--allow-unused-labels", "in.ts"},
			wantConfig: &Config{
				Strict:                       true,
				NoImplicitAny:                true,
				StrictNullChecks:             true,
				...
				AllowUnusedLabelsSet:         true,
				Lib:                          []string{"es2025"},
				UseDefineForClassFields:      true,
			},
		},
		{
			name: "allow-unused-labels negated",
			args: []string{"--no-allow-unused-labels", "in.ts"},
			wantConfig: &Config{
				Strict:                       true,
				NoImplicitAny:                true,
				StrictNullChecks:             true,
		...
		{
			name: "preserve-const-enums flag",
			args: []string{"--preserve-const-enums", "in.ts"},
			wantConfig: &Config{
				Strict:                       true,
				NoImplicitAny:                true,
				StrictNullChecks:             true,
				...
				PreserveConstEnumsSet:        true,
				Lib:                          []string{"es2025"},
				UseDefineForClassFields:      true,
			},
		},
		{
			name: "preserve-const-enums negated",
			args: []string{"--no-preserve-const-enums", "in.ts"},
			wantConfig: &Config{
				Strict:                       true,
				NoImplicitAny:                true,
				StrictNullChecks:             true,
