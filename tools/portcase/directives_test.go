...
func TestTranslateDirectives(t *testing.T) {
	tests := []struct {
		...
		{
			name: "strictFunctionTypes true with injected lib",
			directives: map[string]string{
				"strictFunctionTypes": "true",
			},
			wantFlags: []string{"--strict-function-types", "--lib", "es2025,dom"},
		},
		{
			name: "strictFunctionTypes false with injected lib",
			directives: map[string]string{
		...
		},
		{
			...
			wantFlags: []string{"--no-no-lib", "--lib", "es2025,dom"},
		},
		{
		...
		{
			name: "noEmitHelpers true with injected lib",
			directives: map[string]string{
				"noEmitHelpers": "true",
			},
			wantFlags: []string{"--no-emit-helpers", "--lib", "es2025,dom"},
		},
		{
			name: "noEmitHelpers false with injected lib",
			directives: map[string]string{
				"noEmitHelpers": "false",
			},
		...
		{
			name: "checkJs true with injected lib",
			directives: map[string]string{
				"checkJs": "true",
			},
			wantFlags: []string{"--check-js", "--lib", "es2025,dom"},
		},
		{
			name: "checkJs false with injected lib",
			directives: map[string]string{
				"checkJs": "false",
			},
